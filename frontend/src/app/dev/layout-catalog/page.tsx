...
const entries: CatalogEntry[] = [
  ...
  },
  {
    ...
    data: {
      ...
      items: [
        { icon: { query: "sparkles" }, title: "Scannable", description: "Each point gets a visual anchor and one concise explanation." },
        { icon: { query: "blocks" }, title: "Balanced", description: "Works well for three or four capabilities on one slide." },
        { icon: { query: "shield-check" }, title: "Reliable", description: "Predictable spacing keeps the page from feeling crowded." },
      ],
    },
  },
  {
    ...
    data: {
      title: "Rollout Plan",
      items: [
        { title: "Collect input", description: "Gather source docs, goals, and constraints from the team." },
        { title: "Draft structure", description: "Turn raw material into a short narrative with a clear order." },
        { title: "Polish visuals", description: "Pick a layout, tune wording, and verify readability." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    data: {
      ...
      metrics: [
        { value: "48%", label: "Faster review", description: "less manual cleanup" },
        { value: "11", label: "Teams onboarded", description: "within two sprints" },
        { value: "4.8/5", label: "Satisfaction", description: "pilot feedback" },
      ],
      image: { prompt: "analytics dashboard", url: photoB, alt: "dashboard preview" },
    },
  },
  {
  ...
  },
  {
    ...
    data: {
      ...
      left: { heading: "Manual", icon: { query: "pen-tool" }, items: ["Slower setup", "Inconsistent page rhythm", "Harder to reuse"] },
      right: { heading: "Assisted", icon: { query: "bot" }, items: ["Faster first draft", "Repeatable layout system", "Easier to refine"] },
    },
  },
  {
    ...
    data: {
      ...
      description: "This layout works when one image should do most of the emotional work, with the text explaining why it matters.",
      bullets: ["Strong for demos and case studies", "Keeps the message focused", "Easy to theme with photography"],
    },
  },
  {
    ...
    data: {
      ...
      events: [
        { date: "Week 1", title: "Research", description: "Audit current layouts and sample decks." },
        { date: "Week 2", title: "Prototype", description: "Add new layout components and schemas." },
        { date: "Week 3", title: "Validate", description: "Run generation checks and visual review." },
        { date: "Week 4", title: "Ship", description: "Document patterns and hand off to the team." },
      ],
    },
  },
  {
    ...
    data: {
      quote: "A layout system is just a promise that content will land in a predictable, readable place.",
  ...
  },
  {
    ...
    data: {
      ...
      items: [
        { challenge: "Slides feel visually inconsistent across authors.", outcome: "Use a constrained layout library with schema-guided content." },
        { challenge: "Reviewers spend time fixing spacing and hierarchy.", outcome: "Push style decisions into reusable TSX layouts." },
      ],
    },
  },
  {
    ...
    <main className="min-h-screen bg-slate-50 px-6 py-8 text-slate-900">
      <div className="mx-auto max-w-[1680px]">
        <header className="mb-8">
          ...
          <h1 className="text-3xl font-semibold tracking-tight">Built-in slide layouts</h1>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
            This page renders every current TSX layout with sample data. Treat it as the fastest
            way to compare structure, inspect file names, and decide where to add a new variant.
          </p>
        </header>
          ...
          <table className="min-w-full table-fixed border-collapse">
            ...
            <tbody>
              {entries.map((entry) => {
                ...
                return (
                  <tr key={entry.module.layoutId} className="border-t border-slate-200 align-top">
                    <td className="px-5 py-5">
                      <PreviewFrame Component={Component} data={entry.data} />
                    </td>
                    <td className="px-5 py-5">
                      <div className="text-sm font-semibold text-slate-900">{entry.module.layoutName}</div>
                    ...
                    <td className="px-5 py-5">
                      <div className="text-sm font-medium text-slate-900">{entry.schemaName}</div>
